...
const int buffer_size = 4 * 3000 * 2000;
BYTE* image_buffer;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		SelectObject(hdcScr, CreateCompatibleBitmap(_hdc, 2000, 2000)); //создать совм бмп и выбрать
		PatBlt(hdcScr, 0, 0, 2000, 2000, PATCOPY);//начально закрасить
